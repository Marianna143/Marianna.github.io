...
import type { Metadata } from "next";
// Добавляем Marck_Script в импорт
...
// Настраиваем шрифт для эффекта "письма от руки"
const marckScript = Marck_Script({
    weight: "400",
    subsets: ["cyrillic", "latin"], // Важно: cyrillic для русского языка
...
export default function RootLayout({
    ...
    return (
        // Добавляем переменную marckScript.variable в список классов
