...
const pricingData = [
    {
        ...
        items: [
            { name: "Базовая структура (шапка, подвал, меню, формы)", price: "1200 ₽ / стр" },
            { name: "Интернет-магазин (каталог, корзина, обучение)", price: "от 3000 ₽" },
            { name: "Подключение онлайн-оплаты", price: "1400 ₽" },
            { name: "Подключение доставки", price: "1400 ₽" },
            { name: "Подключение системы заявок", price: "900 ₽" },
            { name: "Оформление блока отзывов", price: "от 700 ₽" },
        ],
        note: "Подходит, если нужен быстрый запуск и понятная админка.",
    },
    {
        title: "Кодовый сайт",
        subtitle: "Индивидуальные решения с расширенной анимацией",
        items: [
            { name: "Продающий одностраничный сайт", price: "от 20 000 ₽" },
            { name: "Многостраничный корпоративный сайт", price: "от 50 000 ₽" },
            { name: "Сложные веб-сервисы и нестандартные функции", price: "по запросу" },
        ],
