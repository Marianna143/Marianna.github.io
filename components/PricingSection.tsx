...
const pricingData = [
    {
        ...
        items: [
            { name: "Лендинг на Тильде (до 7 блоков)", price: "от 18 000 ₽" },
            { name: "Многостраничный сайт на Тильде", price: "от 32 000 ₽" },
            { name: "Интернет-магазин на Тильде", price: "от 45 000 ₽" },
            { name: "Подключение онлайн-оплаты", price: "от 4 000 ₽" },
            { name: "Интеграции (CRM, Telegram, формы)", price: "от 3 500 ₽" },
            { name: "Поддержка и обновления после запуска", price: "от 3 000 ₽ / мес" },
        ],
    ...
    },
    {
        ...
        items: [
            { name: "Продающий кодовый лендинг", price: "от 38 000 ₽" },
            { name: "Многостраничный кодовый сайт", price: "от 65 000 ₽" },
            { name: "Интернет-магазин или сервис на коде", price: "от 95 000 ₽" },
            { name: "Нестандартные функции и личные кабинеты", price: "от 120 000 ₽" },
        ],
