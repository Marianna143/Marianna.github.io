const faqItems = [
    {
        ...
        answer:
            "Стоимость зависит от структуры и задач. Для сайта на Тильде старт обычно ОТ 12 000 ₽, для индивидуального кодового решения — ОТ 24 000 ₽. Точную смету даю после короткого брифа.",
    },
    {
