const faqItems = [
    {
        ...
        answer:
            "Стоимость зависит от структуры и задач. Для сайта на Тильде старт обычно от 18 000 ₽, для индивидуального кодового решения — от 38 000 ₽. Точную смету даю после короткого брифа.",
    },
    {
